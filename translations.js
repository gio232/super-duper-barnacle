...
const TRANSLATIONS = {
  ...
  tax_section2_title: {
    ...
    tax_section2_text: {
    de: '<strong>Steuern in der Schweiz:</strong><br><br>Unten finden Sie einen Vergleich der effektiven Gewinnsteuersätze (CIT) von Unternehmen in allen 26 Schweizer Kantonen. Die Sätze beinhalten Bundes-, Kantons- und Gemeindesteuern und spiegeln die typische Belastung in der Kantonshauptstadt für das Jahr 2026 wider. Körperschaftssteuer in den Schweizer Kantonen Effektiver kombinierter CIT-Satz (Bund + Kanton + Gemeinde), %<br><br>Der Unterschied zwischen dem günstigsten Kanton (Zug — 11.8%) und dem teuersten (Bern — 21.0%) beträgt fast 9 Prozentpunkte, was einer zusätzlichen Steuer von rund CHF 92 000 pro CHF 1 Mio. Gewinn entspricht.<br><br><strong>1. Zug — die beste Balance</strong><br><br>Geeignet für: Holdings, IT, SaaS, Krypto, Trading, internationale Unternehmensgruppen.<br><br><strong>Vorteile:</strong><br>- Der niedrigste Steuersatz im Land (~11.8–11.9%).<br>- „Crypto Valley“ und hohe Konzentration internationaler Unternehmen.<br>- 25–30 Minuten bis zum Flughafen Zürich.<br>- Zugang zum Zürcher Arbeitsmarkt ohne Zürcher Steuern.<br><br><strong>Nachteile:</strong><br>- Sehr teure Immobilien.',
    fr: '<strong>Impôts en Suisse :</strong><br><br>Ci-dessous se trouve un graphique comparatif des taux d\'imposition effectifs sur les bénéfices des sociétés (CIT) dans les 26 cantons suisses. Les taux incluent les impôts fédéraux, cantonaux et communaux et reflètent la charge typique dans la capitale cantonale pour l\'année 2026. Impôt sur le bénéfice des sociétés par canton suisse Taux effectif global du CIT (fédéral + cantonal + communal), %<br><br>La différence entre le canton le plus avantageux (Zoug — 11,8%) et le plus cher (Berne — 21,0%) est de près de 9 points de pourcentage, ce qui équivaut à des impôts supplémentaires d\'environ CHF 92 000 pour chaque CHF 1 million de bénéfice.<br><br><strong>1. Zoug — le meilleur équilibre</strong><br><br>Convient pour : holdings, IT, SaaS, crypto, trading, groupes internationaux de sociétés.<br><br><strong>Avantages :</strong><br>- Le taux d\'imposition le plus bas du pays (~11,8–11,9%).<br>- « Crypto Valley » et forte concentration de sociétés internationales.<br>- 25–30 minutes de l\'aéroport de Zurich.<br>- Accès au marché du travail de Zurich sans les impôts de Zurich.<br><br><strong>Inconvénients :</strong><br>- Immobilier très cher.',
    en: '<strong>Taxes in Switzerland:</strong><br><br>Below is a comparison chart of effective corporate income tax rates (CIT) across all 26 Swiss cantons. The rates include federal, cantonal, and municipal taxes and reflect the typical burden in the cantonal capital for 2026. Corporate income tax by Swiss cantons Effective combined CIT rate (federal + cantonal + municipal), %<br><br>The difference between the most advantageous canton (Zug — 11.8%) and the most expensive (Bern — 21.0%) is almost 9 percentage points, which is equivalent to additional taxes of about CHF 92,000 per CHF 1 million in profit.<br><br><strong>1. Zug — the best balance</strong><br><br>Suitable for: holdings, IT, SaaS, crypto, trading, international groups of companies.<br><br><strong>Pros:</strong><br>- The lowest tax rate in the country (~11.8–11.9%).<br>- "Crypto Valley" and a high concentration of international companies.<br>- 25–30 minutes to Zurich airport.<br>- Access to the Zurich job market without Zurich taxes.<br><br><strong>Cons:</strong><br>- Very expensive real estate.',
    ru: '<strong>Налоги в Швейцарии:</strong><br><br>Ниже приведён график сравнения эффективных ставок налога на прибыль компаний (CIT) по всем 26 кантонам Швейцарии. Ставки включают федеральный, кантональный и муниципальный налоги и отражают типичную нагрузку в столице кантона на 2026 год. Налог на прибыль компаний по кантонам Швейцарии Эффективная совокупная ставка CIT (федеральный + кантональный + муниципальный), %<br><br>Разница между самым выгодным кантоном (Цуг — 11.8%) и самым дорогим (Берн — 21.0%) составляет почти 9 процентных пунктов, что эквивалентно дополнительным налогам около CHF 92 000 на каждый CHF 1 млн прибыли.<br><br><strong>1. Zug — лучший баланс</strong><br><br>Подходит для: холдингов, IT, SaaS, крипто, трейдинга, международных групп компаний.<br><br><strong>Плюсы:</strong><br>- Самая низкая налоговая ставка в стране (~11.8–11.9%).<br>- «Crypto Valley» и высокая концентрация международных компаний.<br>- 25–30 минут до аэропорта Цюриха.<br>- Доступ к рынку труда Цюриха без налогов Цюриха.<br><br><strong>Минусы:</strong><br>- Очень дорогая недвижимость.',
    ua: '<strong>Податки у Швейцарії:</strong><br><br>Нижче наведено графік порівняння ефективних ставок податку на прибуток компаній (CIT) по всіх 26 кантонах Швейцарії. Ставки включають федеральний, кантональний та муніципальний податки і відображають типове навантаження у столиці кантону на 2026 рік. Податок на прибуток компаній по кантонах Швейцарії Ефективна сукупна ставка CIT (федеральний + кантональний + муніципальний), %<br><br>Різниця між найвигіднішим кантоном (Цуг — 11.8%) і найдорожчим (Берн — 21.0%) становить майже 9 відсоткових пунктів, що еквівалентно додатковим податкам близько CHF 92 000 на кожен CHF 1 млн прибутку.<br><br><strong>1. Zug — найкращий баланс</strong><br><br>Підходить для: холдингів, IT, SaaS, крипто, трейдингу, міжнародних груп компаній.<br><br><strong>Плюси:</strong><br>- Найнижча податкова ставка в країні (~11.8–11.9%).<br>- «Crypto Valley» та висока концентрація міжнародних компаній.<br>- 25–30 хвилин до аеропорту Цюриха.<br>- Доступ до ринку праці Цюриха без податків Цюриха.<br><br><strong>Мінуси:</strong><br>- Дуже дорога нерухомість.'
  },
  tax_f1: {
